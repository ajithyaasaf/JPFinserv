...
const MenuFour = () => {
  ...
  return (
    <>
      <div
        className={`header-menu style-four bg-black ${
          fixedHeader ? "fixed" : ""
        }`}
      >
        <div className="container flex items-center justify-between h-20">
          <div
            className="menu-humburger hidden max-lg:block pointer"
          ...
          <div className="menu-center-block h-full">
            <ul className="menu-nav flex items-center xl:gap-2 h-full">
              ...
              >
                <Link
                  className="nav-link text-white text-title flex items-center gap-1"
                  href="#!"
                >
                  <span>Home</span>
                  <span>
          ...
          <div className="menu-right-block flex items-center">
            <Link
              href={"/contact/contact-one"}
              className="button-main bg-success hover:bg-white hover:text-black text-white rounded-full mr-5 max-sm:hidden"
            >
              Get a quote
            </Link>
