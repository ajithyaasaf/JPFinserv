              ...
              <div className="case-study-item">
                <div className="bg-img">
                  <Image
                    ...
                    src="/images/component/person_2.jpg"
                    alt="img"
                  />
                </div>
              ...
              <div className="case-study-item">
                <div className="bg-img">
                  ...
                  <Image
                    ...
                    height={5000}
                    className="w-full h-full block"
                    src="/images/component/person_3.jpg"
                    alt="img"
                  />
                </div>
                <div className="text flex flex-col justify-between gap-3">
              ...
              <div className="case-study-item">
                <div className="bg-img">
                  ...
                  <Image
                    ...
                    height={5000}
                    className="w-full h-full block"
                    src="/images/component/person_1.jpg"
                    alt="img"
                  />
                </div>
                <div className="text flex flex-col justify-between gap-3">
              ...
              <div className="case-study-item">
                <div className="bg-img">
                  ...
                  <Image
                    ...
                    height={5000}
                    className="w-full h-full block"
                    src="/images/component/person_4.jpg"
                    alt="img"
                  />
                </div>
                <div className="text flex flex-col justify-between gap-3">
                  <div className="heading5">
                    <Link
                      ...
                      href="/case-studies/case-studies-one"
                    >
                      Sanction & Disbursement,Payments
                    </Link>
                  </div>
                  <div className="body2 text-white">
